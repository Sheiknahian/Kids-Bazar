...
const OrderSuccess = async({ searchParams }) => {
    ...
    return (
        <div className="min-h-screen bg-[#FFF4D6] px-4 py-10 md:px-10">
            <div className="mx-auto w-full max-w-5xl min-w-0">
                ...
                <div className="grid min-w-0 gap-8 grid-cols-1 md:grid-cols-5">
                    ...
                    {/* Right - Summary */}
                    <div className="h-fit w-full md:col-span-2 rounded-2xl border border-gray-200 bg-white p-4 md:p-6 shadow-sm lg:sticky lg:top-6">
                        <h2 className="mb-6 text-2xl font-bold text-gray-900">
                        Order Summary
                        </h2>
