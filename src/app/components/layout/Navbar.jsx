...
const Navbar = async() => {
  ...
  return (
    <div className="flex justify-between items-center px-10 py-5 bg-base-200 border-b-2 border-primary">
      ...
      <Link href={'/'}>
        <h2 className="text-3xl md:text-4xl text-primary font-bold text-start">Kids <span className="text-black">Bazar</span></h2>
      </Link>
 
      <Link href={'/cartedProducts'} className="lg:hidden text-2xl text-primary">
        <FaCartShopping></FaCartShopping>
      </Link>
      
      <div className="hidden lg:flex gap-12 text-black">
      ...
      </div>
      {
        ...
        :
        <div className="hidden lg:flex items-center gap-2 rounded-full border-2 border-primary bg-white px-3 py-1.5 shadow-sm">
